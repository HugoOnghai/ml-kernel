...
// ================ convolution_im2col testing ======================== //

void test_convolution_im2col(void)
{
    // Setup
    float image_data[1][5][5] = {
        {
...
// implemented with ChatGPT
void test_convolution_im2col_multiple_filters_and_bias(void)
{
    // Image: single channel 5x5 (match init_image signature)
    float image_data[1][5][5] = {
        {
    ...
    float ***convOutput = convolution_im2col(image, numChannels, kernel, biasData, numFilters, 5, kernelSize, MATMUL_BASE);
    int outputSize = 5 - 3 + 1; // 3
