...
// python3 /classes/ece5755/pmu-tools/toplev.py --core S0-C0 -l1 -v --no-desc --force-cpu spr ./gpt2
// python3 /classes/ece5755/pmu-tools/toplev.py --core S0-C0 -l2 -v -no-desc --force-cpu spr ./gpt2